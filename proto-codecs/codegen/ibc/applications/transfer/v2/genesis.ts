...
import { Params, ParamsAmino, ParamsSDKType } from "../v1/transfer";
import { Coin, CoinAmino, CoinSDKType } from "../../../../cosmos/base/v1beta1/coin";
import { PacketId, PacketIdAmino, PacketIdSDKType, Packet, PacketAmino, PacketSDKType } from "../../../core/channel/v1/channel";
...
export interface GenesisStateSDKType {
  ...
  forwarded_packets: ForwardedPacketSDKType[];
}
...
/** ForwardedPacket defines the genesis type necessary to retrieve and store forwarded packets. */
export interface ForwardedPacketSDKType {
  forward_key: PacketIdSDKType;
...
export const ForwardedPacket = {
  ...
  fromPartial(object: Partial<ForwardedPacket>): ForwardedPacket {
    const message = createBaseForwardedPacket();
