...
describe("ClosedOrders", () => {
  ...
  test("displays orders correctly", () => {
    ...
    expect(rows[3].querySelectorAll("td")[5].textContent).toBe("—");
    expect(rows[3].querySelectorAll("td")[6].textContent).toBe("x2");
    expect(rows[3].querySelectorAll("td")[7].textContent).toBe("buy");
    expect(rows[3].querySelectorAll("td")[8].textContent).toBe("Canceled");
    ...
    expect(rows[2].querySelectorAll("td")[4].textContent).toBe("1.1");
    expect(rows[2].querySelectorAll("td")[5].textContent).toBe("USD 4.91");
    expect(rows[2].querySelectorAll("td")[6].textContent).toBe("x2");
    expect(rows[2].querySelectorAll("td")[7].textContent).toBe("buy");
    expect(rows[2].querySelectorAll("td")[8].textContent).toBe("Filled");
    ...
    expect(rows[1].querySelectorAll("td")[4].textContent).toBe("1.1");
    expect(rows[1].querySelectorAll("td")[5].textContent).toBe("USD 4.11");
    expect(rows[1].querySelectorAll("td")[6].textContent).toBe("x2");
    expect(rows[1].querySelectorAll("td")[7].textContent).toBe("buy");
    expect(rows[1].querySelectorAll("td")[8].textContent).toBe("Filled");
  });
