...
import { Hop, HopAmino, HopSDKType } from "../v1/transfer";
 ...
 * https://github.com/cosmos/ibc/tree/master/spec/app/ics-020-fungible-token-transfer#data-structures
 */
export interface FungibleTokenPacketDataV2SDKType {
  tokens: TokenSDKType[];
  sender: string;
  receiver: string;
  memo: string;
  forwarding: ForwardingPacketDataSDKType;
}
/**
 ...
 * final destination of the tokens.
 */
export interface ForwardingPacketDataSDKType {
  destination_memo: string;
  hops: HopSDKType[];
}
...
export const FungibleTokenPacketDataV2 = {
  ...
  fromPartial(object: Partial<FungibleTokenPacketDataV2>): FungibleTokenPacketDataV2 {
    const message = createBaseFungibleTokenPacketDataV2();
...
export const ForwardingPacketData = {
  ...
  fromPartial(object: Partial<ForwardingPacketData>): ForwardingPacketData {
    const message = createBaseForwardingPacketData();
